...
public class WeeklyGoalSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize RadioGroup for weekly goals
        RadioGroup radioGroup = findViewById(R.id.radioGroup_goal);

        // Load goal options from resources
        String[] goalOptions = getResources().getStringArray(R.array.weeklyGoal);

        // Populate RadioGroup with options and set checked state based on saved preferences
        populateRadioGroup(radioGroup, goalOptions, prefsSettings.GOAL_KEY);
